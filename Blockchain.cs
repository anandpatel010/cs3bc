...
namespace BlockchainAssignment
{
    class Blockchain
    {
        ...
        public PoSBlock CreatePoSBlock(List<Transaction> transactions, string validatorAddress, double stakedAmount)
        {
            PoSBlock newBlock = new PoSBlock(GetLastBlock(), transactions, validatorAddress, stakedAmount);
            blocks.Add(newBlock);
            return newBlock;
        }
    }
